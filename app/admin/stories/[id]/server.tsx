...
export default function StoryEditorPage({ story }: { story: StoryRecord }) {
  ...
  const [form, setForm] = useState({
    ...
    body_html: story.body_html ?? "<p></p>",
    featured_image_url: story.featured_image_url ?? "",
    section: story.section ?? "south-sudan",
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const payload = {
        ...
        body_html: form.body_html.trim() || "<p></p>",
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-lg text-[#555]">Update and republish this story.</p>
      </div>
